...
OUTPUT_DIR = "../temp"
PLOT_DIR = "../figures"
MODEL_SAVE_PATH = os.path.join(BASE_DIR, "..", "temp", "ecgcnn_optuna_with_aug_final_retrained.pth")
STUDY_PATH = os.path.join(BASE_DIR, "..", "temp", "ecgcnn_optuna_with_aug_fold4.pkl")
DEMO_PATH = os.path.join(BASE_DIR, "..", "temp", "demo_beats.npz")
